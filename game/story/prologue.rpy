label prologue:
    ...
    # # "Mutiple minutes pass by and my eyelids weigh like a thousand of flowers, dried, withered away by the centuries."
    # # "Mutliples minutes pass by and my eyes sprout a thousand of flowers, stinging my eyes, demanding a desereved rest."
    # "Glimmers of a shining blue indigo and orange dance in the sky sprouting a thousand of flowers above, delivering a magnificient bouquet of shimmering colors."
    # "You were melancholic of this spectacle, because you knew what it meant. The day is already done and all of this will die down to be replaced tomnorrow."
    # "Soon enough, content from its demonstration of fantasies, the dying light of the sun disappears behind the horizon."
    # "Once gone, your eyes start to get heavy, for all they have been doing today is enduring the long day of road you've made, relieved the bright peach light has flown away for another place, warmer and greener."
    # "For a moment, you find yourself complying with your inner desire and give in the call of slumber. Falling down, you meet with the peaceful world of Wonderland where the misery is shrinking away and complete bliss is growing closer."
...
label rest_area_2:
    ...
    "I quickly search for an excuse and determine that his proposition is the best outcome."
